...
package ch.kostceco.tools.siardexcerpt.exception.modulesearch;

import ch.kostceco.tools.siardexcerpt.exception.SIARDexcerptException;

public class SearchAPrimarykeyException extends SIARDexcerptException
{

	private static final long	serialVersionUID	= -8816841335398903517L;

	public SearchAPrimarykeyException( String message )
	{
		super( message );
	}
