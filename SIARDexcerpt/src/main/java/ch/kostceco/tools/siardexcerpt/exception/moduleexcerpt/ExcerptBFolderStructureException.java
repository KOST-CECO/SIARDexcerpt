...
public class ExcerptBFolderStructureException extends SIARDexcerptException
{

	private static final long	serialVersionUID	= -5743334009406087977L;

	public ExcerptBFolderStructureException()
	{
		super();
	}

	public ExcerptBFolderStructureException( String message )
	{
		super( message );
	}
