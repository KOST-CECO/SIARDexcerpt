...
package ch.kostceco.tools.siardexcerpt.excerption.modulesearch.impl;
...
public class SearchAPrimarykeyModuleImpl extends ValidationModuleImpl implements
		SearchAPrimarykeyModule
{
	...
	public boolean validate( File siardDatei, File outFile, String excerptString )
			throws SearchAPrimarykeyException
	{
